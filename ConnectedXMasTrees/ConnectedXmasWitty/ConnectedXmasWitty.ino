 ...
 * 
 * NOTE NOTE NOTE - this is set up for testing on a Witty ESP device, using the built-in button and LEDs
 *
...
// for testing on Witty
#define BUTTON 4
#define RGB_R 15
#define RGB_G 12
#define RGB_B 13
#define TINY_BLUE 2   // tiny blue is on when low.

#define LED_TREETOP 12   // green
#define LED_TREE    15   // red
